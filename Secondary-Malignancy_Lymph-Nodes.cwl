...
steps:
  ...
  secondary-malignancy_lymph-nodes-unspecified---primary:
    run: secondary-malignancy_lymph-nodes-unspecified---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  secondary-malignancy_lymph-nodes---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: secondary-malignancy_lymph-nodes-unspecified---primary/output
